...
class Application(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.word_label.grid(row=0, column=0, padx= 0, pady=0, sticky=tk.W)

        self.word_entry = ttk.Entry(self)
        self.word_entry.grid(row=0, column=1, padx=0, pady=0)
        ...
        self.word_listbox.grid(row=2, column=0, padx=5, pady=5, sticky=tk.W + tk.E + tk.N + tk.S)
        self.word_listbox.bind("<<ListboxSelect>>", self.show_word_info)

        self.word_info_text = tk.Text(self, wrap="word")
        self.word_info_text.grid(row=2, column=1, padx=5, pady=5, sticky=tk.W + tk.E + tk.N + tk.S)
